...
public class HoofdVenster extends JFrame implements ActionListener {
	 ...
	 * 
	 * @param tegel
	 *            De tegel om toe te voegen.
	 * @param bp
	 *            De positie waar de tegel moet komen.
	 */
	...
	/**
	 * Voegt een pion toe aan het PionnenVeld waaruit de speler pionnen kan
	 * kiezen.
	 * 
	 * @param pion
	 *            De pion om toe te voegen.
	 */
	 ...
	 * 
	 * @param tegel
	 *            De Tegel waar de pion op moet geplaatst worden.
	 * @param pion
	 *            De pion om te plaatsen.
	 * @param pos
	 *            De positie op de Tegel waar de pion op moet geplaatst worden.
	 */
	...
	/**
	 * Voegt een PionLuisteraar toe die gewaarschuwd wordt wanneer er op een
	 * pion geklikt wordt.
	 * 
	 * @param pl
	 *            De PionLuisteraar om toe te voegen.
	 */
	...
	public synchronized void verwijderSelectieTegelLuisteraar(
			TegelLuisteraar tkl) {
		this.tegelSelecteer.removeTegelKlikLuisteraar(tkl);
	}

	/**
	 * Maakt het PionnenVeld en het TegelSelectieVeld leeg. Wordt gebruikt bij
	 * het wisselen tussen spelers.
	 */
	...
	/**
	 * Deze functie wordt gebruikt om de eerste tegel van het TegelSelectieVeld
	 * al te selecteren, zodat de speler niet telkens op een tegel moet klikken.
	 */
	...
	/**
	 * Wordt gebruikt om aan de gui aan te geven welke tegel de gebruiker wilt
	 * plaatsen, zodat het TegelVeld deze al kan weergeven bij het bewegen over
	 * het TegelVeld.
	 * 
	 * @param tb
	 *            De Tegel die de gebruiker wil plaatsen.
	 */
	...
	public void zetActieveSpeler(Speler s) {
		...
		if (gevondenSpeler != null) {
			...
			for (int i = 0; i < aantalTegels; i++) {
				this.voegSelectieTegelToe(gevondenSpeler.geefTegel(i)
						.getTegel());
			}
		}
	...
	public synchronized void voegHoofdVensterLuisteraarToe(
			HoofdVensterLuisteraar hvl) {
		this.hoofdVensterLuisteraars.add(hvl);
	}

	public synchronized void verwijderHoofdVensterLuisteraar(
			HoofdVensterLuisteraar hvl) {
		this.hoofdVensterLuisteraars.remove(hvl);
	}

	/**
	 * Wordt gebruikt om te kijken bij een aanpassen van de pionnen en tegels
	 * van een speler of dit de actieve speler is. Indien dit de actieve speler
	 * is, wordt de gui aangepast.
	 * 
	 * @param s
	 */
