...
/**
 * Deze klasse wordt gebruikt om er voor te zorgen dat dezelfde afbeelding niet
 * meerdere keren moet ingeladen worden.
 * 
 * @author Jens
 * 
 */
public class AfbeeldingLader {
	...
	public static BufferedImage geefAfbeelding(String naam) {
		...
		if (index != -1) {
			...
			try {
				BufferedImage nieuweAfbeelding = ImageIO.read(new File(
						afBeeldingMap + naam));
