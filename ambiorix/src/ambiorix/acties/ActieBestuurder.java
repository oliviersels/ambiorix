 ...
 * aanroepen van de verschillende Acties. Acties zelf beslissen de echte
 * game flow.
 * @author olivier
 *
 */
public class ActieBestuurder implements Runnable {
	...
	/**
	 * Aanroepen indien het spel eindigt (buiten de normale game flow)
	 * Dit is een noodrem: breekt de huidige actie onmiddelijk af!
	 */
	public void stop() {		
