...
public class TegelType extends Type {
	...
	/*
	 * Roteert het Terrein met x maal 90 graden en geeft een kopie terug. De
	 * internet terrein wordt dus NIET vervangen !!!!! (is ook niet de
	 * bedoeling, want dit object doet dienst als een FLYWEIGHT en wordt dus
	 * gedeeld door verschillende).
	 */
	...
	private TerreinType[][] draaiNegentig(TerreinType[][] terrein) {
		...
		// MAAR de kolommen staan nog in verkeerde volgorde. Dus eerst
		// transponeren
		...
		while (teller <= midden) {
			// ganse kolom afgaan en waardes kopiëren naar gespiegelde kolom
			// "aan de andere kant"
