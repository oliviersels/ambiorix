...
public class TegelType_LavaPoel extends TegelType
{
	...
	public TegelType_LavaPoel()
	{
		super("TegelType_LavaPoel");
		...
		terrein[0][3] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Gras");
		...
		terrein[1][2] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Lava");
		terrein[1][3] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Lava");
		terrein[1][4] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Gras");
		
		terrein[2][0] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Lava");
		terrein[2][1] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Lava");
		terrein[2][2] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Lava");
		terrein[2][3] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Lava");
		...
		terrein[3][1] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Lava");
		terrein[3][2] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Lava");
		terrein[3][3] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Lava");
		...
		terrein[4][2] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Gras");
