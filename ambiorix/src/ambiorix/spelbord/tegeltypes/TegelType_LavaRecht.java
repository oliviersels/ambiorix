...
public class TegelType_LavaRecht extends TegelType 
{
	...
	public TegelType_LavaRecht()
	{
		super("TegelType_LavaRecht");
		...
		terrein[0][2] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Lava");
		...
		terrein[1][1] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Lava");
		...
		terrein[4][2] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Lava");
