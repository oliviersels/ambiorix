...
public class TegelType_GGGGK extends TegelType
{
	...
	public TegelType_GGGGK()
	{
		...
		terrein[1][2] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Klooster");
		...
		terrein[2][1] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Klooster");
		terrein[2][2] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Klooster");
		terrein[2][3] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Klooster");
		...
		terrein[3][2] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Klooster");
