...
public class TegelType_LavaBocht extends TegelType 
{
	...
	public TegelType_LavaBocht()
	{
		super("TegelType_LavaBocht");
		...
		terrein[3][1] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Gras");
