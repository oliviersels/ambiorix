...
public class TegelType_LavaMetWeg extends TegelType 
{
	...
	public TegelType_LavaMetWeg()
	{
		super("TegelType_LavaMetWeg");
		...
		terrein[0][2] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Weg");
		...
		terrein[1][2] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Weg");
		...
		terrein[2][4] = TerreinTypeVerzameling.getInstantie().getType("TerreinType_Lava");
